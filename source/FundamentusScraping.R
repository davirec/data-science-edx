...
fundamentos_basic01 <- function(tabela){
...
fundamentos_basic02 <- function(tabela){
...
fundamentos_oscilacao <- function(tabela){
...
fundamentos_indicadores <- function(tabela){
...
fundamentos_balaco_patrimonial <- function(tabela){
...
fundamentos_demostrativo <- function(tabela){
  ...
  Receita_Liquida_12_meses <- tabela[2,2]
  EBIT_12_meses <-tabela[3,2]
  Lucro_Liquido_12_meses <- tabela[4,2]
  
  
  Receita_Liquida_3_meses <- tabela[2,4]
  EBIT_3_meses <- tabela[3,4]
  Lucro_Liquido_3_meses <- tabela[4,4]
...
fundamentos_acoes <- function(acao) {
